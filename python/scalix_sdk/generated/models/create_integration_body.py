...
T = TypeVar("T", bound="CreateIntegrationBody")
...
class CreateIntegrationBody:
    ...
    Attributes:
        provider (str): One of `github`, `gitlab`, `bitbucket`.
        repo_url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_integration_body.additional_properties = d
        return create_integration_body
